...
use crate::core::call_tree::{CallTree, CallTreeBuilder};
use crate::core::mem_access::MemAccessIndex;
use crate::core::parallel_types::{
...
use crate::core::scanner::{push_unique, CompactDeps, PairSplitDeps, RegLastDef, CONTROL_DEP_BIT};
...
// Gumtrace annotation replay removed (gumtrace_parser module deleted)
...
use crate::core::Phase2State;
use crate::core::scanner::{ScanState, MemLastDef};
use crate::core::types::TraceFormat;
use crate::core::parallel_types::ChunkResult;
...
pub fn merge_all_chunks(
    ...
    let merged_deps = crate::core::scanner::DepsStorage::Chunked {
        chunks: chunk_deps,
    ...
    eprintln!("[perf] CallTree: {:?}", t.elapsed());
