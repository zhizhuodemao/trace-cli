...
use crate::index::line_index::LineIndexBuilder;
use crate::core::phase2;
use crate::core::insn_class::{self, InsnClass};
...
use crate::core::types::{Operand, RegId, TraceFormat};
...
pub fn scan_chunk(
    ...
    while pos < end_byte {
        ...
        // Parse line
        let parsed = parser::parse_line(raw_line);
        ...
        let (defs, uses) = crate::core::def_use::determine_def_use(class, &line);
...
mod tests {
    use super::*;
    use crate::core::scanner::CONTROL_DEP_BIT;
